...
const moduleBase = {
  ...
  mutations: {
    setElDialogMsg (state, payload) {
      state.elDialogMsg = payload
    },
    setElDialogVisible (state) {
      state.elDialogVisible = !state.elDialogVisible
    },
    setLeftCsvDataset (state,payload) {
      state.leftCsvDataset = payload
    },
    setRightCsvDataset (state,payload) {
      state.rightCsvDataset = payload
    },
    updateChartType (state,payload) {
      state.chartType = payload
    },
    updateBottomFlg (state,payload) {
      state.bottomFlg = payload
    },
    updateStat (state,payload) {
      state.statOld = Object.assign({}, state.stat);
      state.stat[payload.side] = payload.value
    }
